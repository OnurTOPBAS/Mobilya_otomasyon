...
-- siparis kaydi, SIPARISDETAY tablosuna ise bu
-- siparislere ait urun detaylari eklendi.
-- Musteriler, Urunler ve Kategoriler Onur tarafindan eklendi.
-- ================================================
